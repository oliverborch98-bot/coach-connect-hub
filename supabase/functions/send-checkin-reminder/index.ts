  ...
  <div style="max-width:600px;margin:0 auto;background:#1a1a2e;border-radius:12px;overflow:hidden;margin-top:24px;margin-bottom:24px">
    ...
    <div style="padding:32px;color:#e0e0e0;font-size:14px;line-height:1.6">
      ...
      <div style="text-align:center;margin:28px 0">
        <a href="https://builtbyborch.dk/client/check-in" style="display:inline-block;padding:12px 32px;background:#D4A853;color:#1a1a2e;text-decoration:none;border-radius:8px;font-weight:700;font-size:14px">Udfyld check-in nu</a>
      </div>
