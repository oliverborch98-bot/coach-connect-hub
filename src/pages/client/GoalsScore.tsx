      ...
      {score && (
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <div className="h-10 w-10 rounded-full royal-blue-gradient flex items-center justify-center">
            ...
            <div className="ml-auto text-right">
              <p className="text-2xl font-bold royal-blue-text">{score.total_points ?? 0}</p>
              ...
              >
                ...
                <div className="flex items-center gap-3 text-xs text-muted-foreground mb-2">
                  ...
                  <div className="flex-1 h-1.5 bg-secondary rounded-full overflow-hidden">
                    <div className="h-full royal-blue-gradient rounded-full" style={{ width: `${pct}%` }} />
                  </div>
