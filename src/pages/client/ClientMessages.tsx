...
export default function ClientMessages() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-10rem)] md:h-[calc(100vh-12rem)] max-w-lg mx-auto px-1">
      ...
      <form onSubmit={handleSend} className="flex gap-2 mt-3">
        ...
        <button
          ...
          className="royal-blue-gradient rounded-xl p-2.5 text-primary-foreground disabled:opacity-50"
        >
