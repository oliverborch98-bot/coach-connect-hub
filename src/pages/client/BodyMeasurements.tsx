...
export default function BodyMeasurements() {
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto px-4 pb-24 md:pb-8">
            ...
            return (
              <Card key={f.key}>
                <CardContent className="p-4">
                  ...
                  {delta !== null && (
                    <span className={`text-xs flex items-center gap-0.5 ${delta < 0 ? 'text-green-400' : delta > 0 ? 'text-red-400' : 'text-muted-foreground'}`}>
