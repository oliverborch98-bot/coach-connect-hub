        ...
        >
          <div className="bg-card rounded-xl border border-border p-8 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Din adgangskode er blevet ændret. Du kan nu fortsætte til platformen.
            </p>
            <button
              onClick={() => {
                navigate('/');
              }}
              className="w-full royal-blue-gradient rounded-lg py-2.5 text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-90"
            >
              Gå til dashboard
            </button>
          </div>
