          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl border border-border bg-card p-5 grid md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <p className="text-sm font-medium">{age} år</p>
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm font-medium">{client.package_type ?? 'The Build Method 12 uger'}</p>
              </div>
              <div className="space-y-2">
                <p className="text-xs text-muted-foreground">Primært mål</p>
                <p className="text-sm font-medium">{client.primary_goal ?? '–'}</p>
              </div>
              <div className="space-y-2">
                <p className="text-xs text-muted-foreground">Startdato</p>
                <p className="text-sm font-medium">{client.start_date ? new Date(client.start_date).toLocaleDateString('da-DK') : '–'}</p>
              </div>
              <div className="space-y-2">
                <p className="text-xs text-muted-foreground">Status</p>
                <p className="text-sm font-semibold text-success">{client.status ?? 'active'}</p>
              </div>
            </div>
              ...
              <div className="rounded-xl border border-border bg-card p-5">
                ...
                <div className="flex items-center gap-4">
                  <div className="text-center">
                    <p className="text-2xl font-bold">{startW}</p>
                    <p className="text-xs text-muted-foreground">Start</p>
                  </div>
                  <div className="flex-1 h-2 bg-secondary rounded-full overflow-hidden">
                    <div className="h-full gold-gradient rounded-full" style={{ width: `${weightPct}%` }} />
                  </div>
                  <div className="text-center">
                    <p className="text-2xl font-bold text-primary">{currW}</p>
                    <p className="text-xs text-muted-foreground">Nu</p>
                  </div>
                  <div className="text-center">
                    <p className="text-2xl font-bold text-muted-foreground">{goalW}</p>
