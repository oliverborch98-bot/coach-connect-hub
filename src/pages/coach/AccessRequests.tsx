                ...
                <div key={req.id} className="rounded-xl border border-border bg-card p-4 space-y-3">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 gold-gradient rounded-lg py-2 text-sm font-semibold text-primary-foreground hover:opacity-90 transition-opacity flex items-center justify-center gap-1.5"
                    >
